...
namespace website.Odin.Umbraco.ULinkedIn.PropertyEditor.Helpers
{ 
    /// <summary>
    /// A simple C# OAuth2 auth-code wrapper library.
    /// </summary>
    public class OAuth2
    {
        ...
        public static string GetUserInfo(OAuth2Provider provider, string accessToken, Dictionary<string, string> extraParams = null)
        {
            //var parameters = new Dictionary<string, string> {
            //    {"access_token", accessToken}
            //};
            var parameters = new Dictionary<string, string> { //Updated for LinkedIn
